...
//
	...
	#include <GLUT/glut.h>
	#define _glGenVertexArrays(A,B) glGenVertexArraysAPPLE(A,B)
	#define _glBindVertexArray(A) glBindVertexArrayAPPLE(A)
#else // non-Mac OS X operating systems
	#include <GL/glew.h>
	#include <GL/freeglut.h>
	#include <GL/freeglut_ext.h>
	#define _glGenVertexArrays(A,B)  glGenVertexArrays(A,B)
	#define _glBindVertexArray(A) glBindVertexArray(A)
#endif  // __APPLE__
